...
CREATE DATABASE `ocdb` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `ocdb`;
...
DROP TABLE IF EXISTS `mall_api`;
CREATE TABLE `mall_api` (
...
INSERT INTO `mall_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1,	'Default',	'',	1,	'2017-11-16 23:17:15',	'2017-11-16 23:17:15');

DROP TABLE IF EXISTS `mall_api_ip`;
CREATE TABLE `mall_api_ip` (
...
DROP TABLE IF EXISTS `mall_api_session`;
CREATE TABLE `mall_api_session` (
...
INSERT INTO `mall_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1,	6,	1),
(2,	6,	5),
(3,	6,	3),
(4,	3,	1),
...
DROP TABLE IF EXISTS `mall_attribute_description`;
CREATE TABLE `mall_attribute_description` (
...
INSERT INTO `mall_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1,	1,	'Description'),
(2,	1,	'No. of Cores'),
(4,	1,	'test 1'),
(5,	1,	'test 2'),
...
DROP TABLE IF EXISTS `mall_attribute_group`;
CREATE TABLE `mall_attribute_group` (
  `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`attribute_group_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

INSERT INTO `mall_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3,	2),
(4,	1),
(5,	3),
(6,	4);

DROP TABLE IF EXISTS `mall_attribute_group_description`;
CREATE TABLE `mall_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
INSERT INTO `mall_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3,	1,	'Memory'),
(4,	1,	'Technical'),
(5,	1,	'Motherboard'),
(6,	1,	'Processor');
...
INSERT INTO `mall_banner` (`banner_id`, `name`, `status`) VALUES
(6,	'HP Products',	1),
(7,	'Home Page Slideshow',	1),
(8,	'Manufacturers',	1);

DROP TABLE IF EXISTS `mall_banner_image`;
CREATE TABLE `mall_banner_image` (
...
INSERT INTO `mall_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
INSERT INTO `mall_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
DROP TABLE IF EXISTS `mall_category_description`;
CREATE TABLE `mall_category_description` (
...
INSERT INTO `mall_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
DROP TABLE IF EXISTS `mall_category_filter`;
CREATE TABLE `mall_category_filter` (
  `category_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `mall_category_path`;
CREATE TABLE `mall_category_path` (
  `category_id` int(11) NOT NULL,
...
INSERT INTO `mall_category_path` (`category_id`, `path_id`, `level`) VALUES
(25,	25,	0),
(28,	25,	0),
(28,	28,	1),
(35,	25,	0),
...
DROP TABLE IF EXISTS `mall_category_to_layout`;
CREATE TABLE `mall_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `mall_category_to_store`;
CREATE TABLE `mall_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `mall_category_to_store` (`category_id`, `store_id`) VALUES
(17,	0),
(18,	0),
(20,	0),
(24,	0),
...
DROP TABLE IF EXISTS `mall_country`;
CREATE TABLE `mall_country` (
...
INSERT INTO `mall_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
INSERT INTO `mall_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
(4,	'-10% Discount',	'2222',	'P',	10.0000,	0,	0,	0.0000,	'2014-01-01',	'2020-01-01',	10,	'10',	0,	'2009-01-27 13:55:03'),
(5,	'Free Shipping',	'3333',	'P',	0.0000,	0,	1,	100.0000,	'2014-01-01',	'2014-02-01',	10,	'10',	0,	'2009-03-14 21:13:53'),
(6,	'-10.00 Discount',	'1111',	'F',	10.0000,	0,	0,	10.0000,	'2014-01-01',	'2020-01-01',	100000,	'10000',	0,	'2009-03-14 21:15:18');

DROP TABLE IF EXISTS `mall_coupon_category`;
CREATE TABLE `mall_coupon_category` (
...
DROP TABLE IF EXISTS `mall_currency`;
CREATE TABLE `mall_currency` (
...
INSERT INTO `mall_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1,	'Pound Sterling',	'GBP',	'£',	'',	'2',	0.61250001,	1,	'2014-09-25 14:40:00'),
(2,	'US Dollar',	'USD',	'$',	'',	'2',	1.00000000,	1,	'2017-11-16 15:18:30'),
...
DROP TABLE IF EXISTS `mall_customer_activity`;
CREATE TABLE `mall_customer_activity` (
...
DROP TABLE IF EXISTS `mall_customer_affiliate`;
CREATE TABLE `mall_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(40) NOT NULL,
...
DROP TABLE IF EXISTS `mall_customer_approval`;
CREATE TABLE `mall_customer_approval` (
...
DROP TABLE IF EXISTS `mall_customer_group`;
CREATE TABLE `mall_customer_group` (
...
INSERT INTO `mall_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1,	0,	1);

DROP TABLE IF EXISTS `mall_customer_group_description`;
CREATE TABLE `mall_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
INSERT INTO `mall_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1,	1,	'Default',	'test');

DROP TABLE IF EXISTS `mall_customer_history`;
CREATE TABLE `mall_customer_history` (
...
DROP TABLE IF EXISTS `mall_customer_ip`;
CREATE TABLE `mall_customer_ip` (
...
DROP TABLE IF EXISTS `mall_customer_online`;
CREATE TABLE `mall_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
DROP TABLE IF EXISTS `mall_customer_reward`;
CREATE TABLE `mall_customer_reward` (
...
DROP TABLE IF EXISTS `mall_customer_search`;
CREATE TABLE `mall_customer_search` (
...
DROP TABLE IF EXISTS `mall_customer_transaction`;
CREATE TABLE `mall_customer_transaction` (
...
DROP TABLE IF EXISTS `mall_customer_wishlist`;
CREATE TABLE `mall_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
...
DROP TABLE IF EXISTS `mall_custom_field`;
CREATE TABLE `mall_custom_field` (
...
DROP TABLE IF EXISTS `mall_custom_field_customer_group`;
CREATE TABLE `mall_custom_field_customer_group` (
...
DROP TABLE IF EXISTS `mall_custom_field_description`;
CREATE TABLE `mall_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
DROP TABLE IF EXISTS `mall_custom_field_value`;
CREATE TABLE `mall_custom_field_value` (
...
DROP TABLE IF EXISTS `mall_custom_field_value_description`;
CREATE TABLE `mall_custom_field_value_description` (
...
DROP TABLE IF EXISTS `mall_download`;
CREATE TABLE `mall_download` (
...
DROP TABLE IF EXISTS `mall_download_description`;
CREATE TABLE `mall_download_description` (
...
DROP TABLE IF EXISTS `mall_event`;
...
INSERT INTO `mall_event` (`event_id`, `code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
DROP TABLE IF EXISTS `mall_extension`;
CREATE TABLE `mall_extension` (
...
INSERT INTO `mall_extension` (`extension_id`, `type`, `code`) VALUES
(1,	'payment',	'cod'),
(2,	'total',	'shipping'),
(3,	'total',	'sub_total'),
(4,	'total',	'tax'),
...
DROP TABLE IF EXISTS `mall_extension_install`;
CREATE TABLE `mall_extension_install` (
...
DROP TABLE IF EXISTS `mall_extension_path`;
CREATE TABLE `mall_extension_path` (
...
DROP TABLE IF EXISTS `mall_filter`;
CREATE TABLE `mall_filter` (
...
DROP TABLE IF EXISTS `mall_filter_description`;
CREATE TABLE `mall_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
DROP TABLE IF EXISTS `mall_filter_group`;
CREATE TABLE `mall_filter_group` (
...
DROP TABLE IF EXISTS `mall_filter_group_description`;
CREATE TABLE `mall_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
DROP TABLE IF EXISTS `mall_geo_zone`;
CREATE TABLE `mall_geo_zone` (
...
INSERT INTO `mall_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
INSERT INTO `mall_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3,	1,	3,	1),
(4,	1,	1,	1),
(5,	1,	4,	1),
(6,	1,	2,	1);

DROP TABLE IF EXISTS `mall_information_description`;
CREATE TABLE `mall_information_description` (
...
INSERT INTO `mall_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(4,	1,	'About Us',	'&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n',	'About Us',	'',	''),
(5,	1,	'Terms &amp; Conditions',	'&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n',	'Terms &amp; Conditions',	'',	''),
(3,	1,	'Privacy Policy',	'&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n',	'Privacy Policy',	'',	''),
(6,	1,	'Delivery Information',	'&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n',	'Delivery Information',	'',	'');

DROP TABLE IF EXISTS `mall_information_to_layout`;
CREATE TABLE `mall_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `mall_information_to_store`;
CREATE TABLE `mall_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `mall_information_to_store` (`information_id`, `store_id`) VALUES
(3,	0),
(4,	0),
(5,	0),
(6,	0);

DROP TABLE IF EXISTS `mall_language`;
CREATE TABLE `mall_language` (
...
INSERT INTO `mall_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
...
INSERT INTO `mall_layout` (`layout_id`, `name`) VALUES
(1,	'Home'),
(2,	'Product'),
(3,	'Category'),
(4,	'Default'),
...
DROP TABLE IF EXISTS `mall_layout_module`;
CREATE TABLE `mall_layout_module` (
...
INSERT INTO `mall_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2,	4,	'0',	'content_top',	0),
(3,	4,	'0',	'content_top',	1),
...
DROP TABLE IF EXISTS `mall_layout_route`;
CREATE TABLE `mall_layout_route` (
...
INSERT INTO `mall_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(38,	6,	0,	'account/%'),
(17,	10,	0,	'affiliate/%'),
...
DROP TABLE IF EXISTS `mall_length_class`;
CREATE TABLE `mall_length_class` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL,
  PRIMARY KEY (`length_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

INSERT INTO `mall_length_class` (`length_class_id`, `value`) VALUES
(1,	1.00000000),
(2,	10.00000000),
(3,	0.39370000);

DROP TABLE IF EXISTS `mall_length_class_description`;
CREATE TABLE `mall_length_class_description` (
...
INSERT INTO `mall_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1,	1,	'Centimeter',	'cm'),
(2,	1,	'Millimeter',	'mm'),
(3,	1,	'Inch',	'in');

DROP TABLE IF EXISTS `mall_location`;
...
DROP TABLE IF EXISTS `mall_manufacturer`;
CREATE TABLE `mall_manufacturer` (
...
INSERT INTO `mall_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
DROP TABLE IF EXISTS `mall_manufacturer_to_store`;
CREATE TABLE `mall_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`manufacturer_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `mall_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5,	0),
(6,	0),
(7,	0),
(8,	0),
...
DROP TABLE IF EXISTS `mall_marketing`;
CREATE TABLE `mall_marketing` (
...
DROP TABLE IF EXISTS `mall_modification`;
CREATE TABLE `mall_modification` (
...
DROP TABLE IF EXISTS `mall_module`;
CREATE TABLE `mall_module` (
...
INSERT INTO `mall_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
DROP TABLE IF EXISTS `mall_option`;
CREATE TABLE `mall_option` (
...
INSERT INTO `mall_option` (`option_id`, `type`, `sort_order`) VALUES
(1,	'radio',	1),
(2,	'checkbox',	2),
(4,	'text',	3),
(5,	'select',	4),
...
DROP TABLE IF EXISTS `mall_option_description`;
CREATE TABLE `mall_option_description` (
...
INSERT INTO `mall_option_description` (`option_id`, `language_id`, `name`) VALUES
(1,	1,	'Radio'),
(2,	1,	'Checkbox'),
(4,	1,	'Text'),
(6,	1,	'Textarea'),
...
DROP TABLE IF EXISTS `mall_option_value`;
CREATE TABLE `mall_option_value` (
...
INSERT INTO `mall_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43,	1,	'',	3),
(32,	1,	'',	1),
(45,	2,	'',	4),
(44,	2,	'',	3),
...
DROP TABLE IF EXISTS `mall_option_value_description`;
CREATE TABLE `mall_option_value_description` (
...
INSERT INTO `mall_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43,	1,	1,	'Large'),
(32,	1,	1,	'Small'),
(45,	1,	2,	'Checkbox 4'),
(44,	1,	2,	'Checkbox 3'),
...
DROP TABLE IF EXISTS `mall_order_history`;
CREATE TABLE `mall_order_history` (
...
DROP TABLE IF EXISTS `mall_order_option`;
CREATE TABLE `mall_order_option` (
...
DROP TABLE IF EXISTS `mall_order_recurring`;
CREATE TABLE `mall_order_recurring` (
...
DROP TABLE IF EXISTS `mall_order_recurring_transaction`;
CREATE TABLE `mall_order_recurring_transaction` (
...
DROP TABLE IF EXISTS `mall_order_shipment`;
CREATE TABLE `mall_order_shipment` (
...
INSERT INTO `mall_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2,	1,	'Processing'),
(3,	1,	'Shipped'),
(7,	1,	'Canceled'),
(5,	1,	'Complete'),
...
DROP TABLE IF EXISTS `mall_order_total`;
CREATE TABLE `mall_order_total` (
...
DROP TABLE IF EXISTS `mall_order_voucher`;
CREATE TABLE `mall_order_voucher` (
...
INSERT INTO `mall_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES
...
INSERT INTO `mall_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43,	2,	1,	'1'),
(47,	4,	1,	'16GB'),
(43,	4,	1,	'8gb'),
(42,	3,	1,	'100mhz'),
...
DROP TABLE IF EXISTS `mall_product_description`;
CREATE TABLE `mall_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
INSERT INTO `mall_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(35,	1,	'Product 8',	'&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n',	'',	'Product 8',	'',	''),
...
INSERT INTO `mall_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
DROP TABLE IF EXISTS `mall_product_filter`;
CREATE TABLE `mall_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
...
INSERT INTO `mall_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
DROP TABLE IF EXISTS `mall_product_option`;
CREATE TABLE `mall_product_option` (
...
INSERT INTO `mall_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224,	35,	11,	'',	1),
...
DROP TABLE IF EXISTS `mall_product_option_value`;
CREATE TABLE `mall_product_option_value` (
...
INSERT INTO `mall_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
DROP TABLE IF EXISTS `mall_product_recurring`;
CREATE TABLE `mall_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `mall_product_related`;
CREATE TABLE `mall_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`related_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `mall_product_related` (`product_id`, `related_id`) VALUES
(40,	42),
(41,	42),
(42,	40),
(42,	41);

DROP TABLE IF EXISTS `mall_product_reward`;
CREATE TABLE `mall_product_reward` (
...
INSERT INTO `mall_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515,	42,	1,	100),
(519,	47,	1,	300),
(379,	28,	1,	400),
(329,	43,	1,	600),
...
DROP TABLE IF EXISTS `mall_product_special`;
CREATE TABLE `mall_product_special` (
...
INSERT INTO `mall_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
(419,	42,	1,	1,	90.0000,	'0000-00-00',	'0000-00-00'),
(439,	30,	1,	2,	90.0000,	'0000-00-00',	'0000-00-00'),
(438,	30,	1,	1,	80.0000,	'0000-00-00',	'0000-00-00');

DROP TABLE IF EXISTS `mall_product_to_category`;
CREATE TABLE `mall_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
INSERT INTO `mall_product_to_category` (`product_id`, `category_id`) VALUES
(28,	20),
(28,	24),
(29,	20),
(29,	24),
...
DROP TABLE IF EXISTS `mall_product_to_download`;
CREATE TABLE `mall_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `mall_product_to_layout`;
CREATE TABLE `mall_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `mall_product_to_store`;
CREATE TABLE `mall_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `mall_product_to_store` (`product_id`, `store_id`) VALUES
(28,	0),
(29,	0),
(30,	0),
(31,	0),
...
DROP TABLE IF EXISTS `mall_recurring`;
CREATE TABLE `mall_recurring` (
...
DROP TABLE IF EXISTS `mall_recurring_description`;
CREATE TABLE `mall_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `mall_return`;
CREATE TABLE `mall_return` (
...
DROP TABLE IF EXISTS `mall_return_action`;
CREATE TABLE `mall_return_action` (
...
INSERT INTO `mall_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1,	1,	'Refunded'),
(2,	1,	'Credit Issued'),
...
INSERT INTO `mall_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1,	1,	'Dead On Arrival'),
...
DROP TABLE IF EXISTS `mall_return_status`;
CREATE TABLE `mall_return_status` (
...
INSERT INTO `mall_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1,	1,	'Pending'),
(3,	1,	'Complete'),
...
DROP TABLE IF EXISTS `mall_seo_url`;
CREATE TABLE `mall_seo_url` (
...
INSERT INTO `mall_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES
...
DROP TABLE IF EXISTS `mall_session`;
...
INSERT INTO `mall_session` (`session_id`, `data`, `expire`) VALUES
('9aaa2b182f8380c854b7ed83ca',	'{\"user_id\":\"1\",\"user_token\":\"b0iT7WEXroTp2PyXWMNKHQjiLKdr9k2a\"}',	'2017-11-16 15:43:39');
...
INSERT INTO `mall_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(42,	0,	'config',	'config_invoice_prefix',	'INV-2017-00',	0),
...
(201,	0,	'config',	'config_email',	'q-cute@163.com',	0),
...
(202,	0,	'config',	'config_encryption',	'',	0),
...
DROP TABLE IF EXISTS `mall_shipping_courier`;
CREATE TABLE `mall_shipping_courier` (
...
INSERT INTO `mall_shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`) VALUES
(1,	'dhl',	'DHL'),
(2,	'fedex',	'Fedex'),
(3,	'ups',	'UPS'),
...
DROP TABLE IF EXISTS `mall_statistics`;
CREATE TABLE `mall_statistics` (
...
INSERT INTO `mall_statistics` (`statistics_id`, `code`, `value`) VALUES
(1,	'order_sale',	0.0000),
...
DROP TABLE IF EXISTS `mall_stock_status`;
CREATE TABLE `mall_stock_status` (
...
INSERT INTO `mall_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7,	1,	'In Stock'),
(8,	1,	'Pre-Order'),
(5,	1,	'Out Of Stock'),
(6,	1,	'2-3 Days');
...
DROP TABLE IF EXISTS `mall_tax_class`;
CREATE TABLE `mall_tax_class` (
...
INSERT INTO `mall_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
(9,	'Taxable Goods',	'Taxed goods',	'2009-01-06 23:21:53',	'2011-09-23 14:07:50'),
(10,	'Downloadable Products',	'Downloadable',	'2011-09-21 22:19:39',	'2011-09-22 10:27:36');

DROP TABLE IF EXISTS `mall_tax_rate`;
CREATE TABLE `mall_tax_rate` (
...
INSERT INTO `mall_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
(86,	3,	'VAT (20%)',	20.0000,	'P',	'2011-03-09 21:17:10',	'2011-09-22 22:24:29'),
(87,	3,	'Eco Tax (-2.00)',	2.0000,	'F',	'2011-09-21 21:49:23',	'2011-09-23 00:40:19');

DROP TABLE IF EXISTS `mall_tax_rate_to_customer_group`;
CREATE TABLE `mall_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  PRIMARY KEY (`tax_rate_id`,`customer_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `mall_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86,	1),
(87,	1);

DROP TABLE IF EXISTS `mall_tax_rule`;
CREATE TABLE `mall_tax_rule` (
...
INSERT INTO `mall_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121,	10,	86,	'payment',	1),
(120,	10,	87,	'store',	0),
(128,	9,	86,	'shipping',	1),
(127,	9,	87,	'shipping',	2);
...
DROP TABLE IF EXISTS `mall_translation`;
CREATE TABLE `mall_translation` (
...
DROP TABLE IF EXISTS `mall_upload`;
CREATE TABLE `mall_upload` (
...
INSERT INTO `mall_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1,	1,	'joy',	'20ddd98bf8117b09f63a8f5dd57bf46827fa9e99',	'LZDwFRWEd',	'John',	'Doe',	'q-cute@163.com',	'',	'',	'127.0.0.1',	1,	'2017-11-16 23:17:15');

DROP TABLE IF EXISTS `mall_user_group`;
CREATE TABLE `mall_user_group` (
...
INSERT INTO `mall_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
DROP TABLE IF EXISTS `mall_voucher_history`;
CREATE TABLE `mall_voucher_history` (
...
DROP TABLE IF EXISTS `mall_voucher_theme`;
CREATE TABLE `mall_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) NOT NULL,
  PRIMARY KEY (`voucher_theme_id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

INSERT INTO `mall_voucher_theme` (`voucher_theme_id`, `image`) VALUES
(8,	'catalog/demo/canon_eos_5d_2.jpg'),
(7,	'catalog/demo/gift-voucher-birthday.jpg'),
(6,	'catalog/demo/apple_logo.jpg');

DROP TABLE IF EXISTS `mall_voucher_theme_description`;
CREATE TABLE `mall_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
INSERT INTO `mall_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6,	1,	'Christmas'),
(7,	1,	'Birthday'),
(8,	1,	'General');

DROP TABLE IF EXISTS `mall_weight_class`;
CREATE TABLE `mall_weight_class` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`weight_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

INSERT INTO `mall_weight_class` (`weight_class_id`, `value`) VALUES
(1,	1.00000000),
(2,	1000.00000000),
(5,	2.20460000),
(6,	35.27400000);

DROP TABLE IF EXISTS `mall_weight_class_description`;
CREATE TABLE `mall_weight_class_description` (
...
INSERT INTO `mall_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1,	1,	'Kilogram',	'kg'),
(2,	1,	'Gram',	'g'),
(5,	1,	'Pound ',	'lb'),
(6,	1,	'Ounce',	'oz');

DROP TABLE IF EXISTS `mall_zone`;
...
INSERT INTO `mall_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
DROP TABLE IF EXISTS `mall_zone_to_geo_zone`;
CREATE TABLE `mall_zone_to_geo_zone` (
...
INSERT INTO `mall_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
