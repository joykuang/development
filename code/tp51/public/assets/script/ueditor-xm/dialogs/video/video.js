     ...
     function createAlignButton( ids ) {
         for ( var i = 0, ci; ci = ids[i++]; ) {
             ...
             for ( var j in nameMaps ) {
                ...
                if(j=='none')
                {   div.className="focus";
                    div.style.cssText = "width:30px;height: 30px;background:#fff8e1 url(images/alignicon.jpg) no-repeat;background-position:0px -2px;";
                }    
                if(j=='left')
                {
                    div.style.cssText = "width:30px;height: 30px;background:url(images/alignicon.jpg) no-repeat;background-position:-30px -2px;";
                } 
                if(j=='right')
                {
                    div.style.cssText = "width:30px;height: 30px;background:url(images/alignicon.jpg) no-repeat;background-position:-0px -26px;";
                } 
                if(j=='center')
                {
                    div.style.cssText = "width:30px;height: 30px;background:url(images/alignicon.jpg) no-repeat;background-position:-30px -26px;";
                } 
    ...
    function addUrlChangeListener(url){
        if (browser.ie) {
            ...
            url.addEventListener( "input", function () {
                createPreviewVideo(escape(this.value));
            }, false );
        }
    }
