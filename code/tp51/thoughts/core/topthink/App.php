...
class App implements \ArrayAccess
{
    ...
    public function __construct($appPath = null)
    {
        ...
        if (is_null($appPath) || !is_dir($appPath)) throw new \Exception("Application Path is unvalid", 1);
        ...
        $this->thinkPath   = realpath($this->rootPath) . '/thoughts/packages/topthink/framework/'; //dirname(dirname(__DIR__)) . '/';
    ...
    public function initialize()
    {
        ...
        $loader->addPsr4($this->namespace . '\\', $this->appPath);
        $loader->register();
        ...
        if (!empty($this->config('app.root_namespace'))) {
            ...
            foreach ($this->config('app.root_namespace') as $psr4) {
                list($namespace, $path) = $psr4;
